@php
    $navigation = [
        ...
        ['label' => 'Products', 'route' => 'admin.products.index', 'active' => 'admin.products.*', 'permission' => 'products.manage', 'icon' => 'M6 7.5h12l-1.5 12h-9L6 7.5zM8.25 7.5a3.75 3.75 0 017.5 0'],
