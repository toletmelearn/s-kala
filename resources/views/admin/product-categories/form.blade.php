<form method="POST" action="{{ $action }}" class="grid gap-6 xl:grid-cols-[1fr_0.42fr]">
    ...
    <aside class="rounded-3xl border border-rose-100 bg-white p-6 shadow-xl shadow-rose-100/50">
        ...
        <a href="{{ route('admin.product-categories.index') }}" class="mt-3 inline-flex w-full justify-center rounded-md border border-rose-100 px-4 py-2 text-sm font-semibold text-stone-600 hover:bg-rose-50">Back</a>
    </aside>
</form>
